...
- (void)validate
{
  ...
  if(self.columnCount * self.cellSize.width < self.size.width){
    self.columnCount++;
    self.cellSize = CGSizeMake(self.size.width / self.columnCount,  self.size.width / self.columnCount / self.cellAspectRatio ) ;
  }
}
